...
%%
% Crear una celda para almacenar todas las imágenes resultado
resultImages = cell(numTestImages, 1);

% Leer las imágenes de prueba y procesarlas
for i = 1:numTestImages
    I = imread(testDataTbl.imageFilename{i});
    I = imresize(I, inputSize(1:2));
...
% Mostrar todas las imágenes resultado en un collage
figure;
montage(resultImages, 'Size', [6, 6]);
%% train 1 photo and resize image like the training images
